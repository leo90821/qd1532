...
K.extend(KSWFUpload, {
	init : function(options) {
		...
		self.div = K(options.container).html([
			...
			'</div>',
			'<div class="ke-inline-block ke-swfupload-desc confirm2">' + options.uploadDesc + '</div>',
...
KindEditor.plugin('multiimage', function(K) {
	var self = this, name = 'multiimage',
		...
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png;*.JPG;*.GIF;*.PNG'),
		//上传的最大数量
		imageUploadLimit = K.undef(self.imageUploadLimit, 5),
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			fileTypes : '*.jpg;*.jpeg;*.gif;*.png;*.bmp;*.JPG;*.PNG;*.JPEG',
